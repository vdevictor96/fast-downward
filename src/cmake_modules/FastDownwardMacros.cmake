...
macro(fast_downward_set_compiler_flags)
    ...
    elseif(MSVC)
        ...
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /wd4018") # signed/unsigned mismatch (level 3)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /wd4389") # signed/unsigned mismatch (level 4)
